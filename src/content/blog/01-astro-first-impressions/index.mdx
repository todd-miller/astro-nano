...
1. easy to deploy
2. can immediately start writing content: [blog/05-measurement-tool](../../blog/05-measurement-tool)
3. can embed examples of the code I'm referencing
4. complete control to control every aspect of the site, I'm a web developer after all
5. grab a template or combination of templates
6. typescript, tailwind, deno?
